		...
		<div class="col-lg-10">
			<form method="POST" action="./updateAction"
				...
				<input type="hidden" name="boarder_id"
					value="${map.boarder.boarder_id }">
				<table class="table table-striped"
					style="text-align: center; border: 1px solid #bbbbbb;">
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #eeeeee; text-align: center;">게시물</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td><input type="text" class="form-control" name="title"
								value="${map.boarder.title }"></td>
						</tr>
						<tr>
							<td>작성자</td>
							<td><input type="hidden" name="writer"
								value="${map.boarder.writer }">${map.boarder.writer }</td>
						...
						<tr>
							...
							<td><textarea class="form-control" name="contents"
									style="height: 350px;">${map.boarder.contents }</textarea></td>
						</tr>
						...
						<tr>
							<td colspan="2"><input type="file" class="form-control"
								id="file" placeholder="첨부파일" name="file"></td>
						</tr>
					</tbody>
				</table>
